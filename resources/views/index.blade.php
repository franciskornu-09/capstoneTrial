...
<head>
    ...
    <link href="{{ assets('/plugins/bootstrap/bootstrap.css') }}" type="text/css" rel="stylesheet" media="all">
    <link href="{{ assets('/font-awesome/css/font-awesome.css') }}" type="text/css" rel="stylesheet" media="all" >
    <link href="{{ assets('/plugins/pace/pace-theme-big-counter.css') }}" type="text/css" rel="stylesheet" media="all" >
    <link href="{{ assets('/css/style.css') }}" type="text/css" rel="stylesheet" media="all" >
    <link href="{{ assets('/css/main-style.css') }}" type="text/css" rel="stylesheet" media="all" />
    <!-- Page-Level CSS -->
    <link href="{{ assets('/plugins/morris/morris-0.4.3.min.css') }}" type="text/css" rel="stylesheet" media="all" >
   </head>
<body>
    <!--  wrapper -->
    <div id="wrapper">
